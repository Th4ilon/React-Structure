...
import {
  ...
  updateUser,
  deleteUser
} from 'services/administration/administradores';
  ...
  constructor(props) {
    ...
    this.state = {
      columns: [
        ...
        { name: 'nombre', title: 'Administrador' },
  ...
  render() {
    ...
    return (
      <div className="text-center">
        <button type="button" className="btn btn-danger btn-lg btn-block" onClick={() => { this.showAddDialog(); }}><strong>Añadir usuario</strong></button>
        <div className="card card-table">
          ...
          <AddUserAdmin
            modalTitle={isEdit ? 'Editar usuarios administradores' : 'Añadir usuario administrador'}
            formButtonText={isEdit ? 'Editar usuario' : 'Añadir'}
            isOpen={isOpen}
